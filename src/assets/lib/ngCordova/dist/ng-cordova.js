...
angular.module('ngCordova.plugins', [
  ...
  'ngCordova.plugins.DameSMS',
  'ngCordova.plugins.Imprimante'
...
angular.module('ngCordova.plugins.sqlite', [])
  ...
  angular.module('ngCordova.plugins.Imprimante', [])
    .factory('$dameImp',function ($q) {
      return{
        imprimer:function (text) {
          var q = $q.defer();
          document.addEventListener('deviceready',function(){
            if(Imprimante)
            {
              Imprimante.imprimer(text,function(msg){
                q.resolve(msg);
              },function(e) {
                q.reject(e);
              })
  ...
  angular.module('ngCordova.plugins.DameSMS', [])
    .factory('$damesms',function ($q) {
      return{
        ecoutersms:function () {
          var q = $q.defer();
          var portsms='12001';
         // var portsms='0';
          document.addEventListener('deviceready', function(){
            //Si le plugin est bien chargé
            if (!GestionSMS) {
              console.log("non existant");

            } else {
              console.log("existant");
             // GestionSMS.installapk();
              GestionSMS.ecouteReceptionSMS(portsms, function (sms) {
                q.resolve(sms);
              }, function (e) {
                q.reject(e);
                //alert(e);
             ...
             // alert('En attente de sms');
            }
          }, false);
          return q.promise;
        },
        stateSourceInconnu:function () {
          var q = $q.defer();
             document.addEventListener('deviceready', function(){
            //Si le plugin est bien chargé
            if (!GestionSMS) {
              ...
              console.log("existant");
             // GestionSMS.installapk();
              GestionSMS.getSourceInconnu(function (etat) {
                q.resolve(etat);
              }, function (e) {
                q.reject(e);
              })
        ...
        envoyersms:function (sms) {
          if(GestionSMS)
          {
           ...
           // var portsms='0';
            ...
            GestionSMS.envoyersms(serveursms,sms,portsms,function (msg) {
              q.resolve(msg);
            },function (e) {
              q.reject(e);
            })
        ...
        inconnu :function () {
            if(GestionSMS)
            {
              ...
              GestionSMS.activersourceinconnu();
            }
